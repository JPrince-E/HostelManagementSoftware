...
public class AllStudentLiving extends javax.swing.JFrame {
    ...
    public AllStudentLiving() {
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from newstudent where roomstatus='Living'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother Name", "Email", "Address", "College Name", "Unique Number", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 56, 680, -1));
